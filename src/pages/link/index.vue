  ...
  <div class="linkPage container h-full pt-5 px-3 md:py-10">
    ...
    <div class="linkHeader">
      <nuxt-link to="/link" class="flex items-stretch justify-center">
        <img src="@/static/images/logo.svg" class="head-logo" alt="Checkout by StreamPay" />
        <div
      ...
      <ul
        v-if="!showAddLink"
        class="feature-list container font-light text-dark mt-4 mr-auto ml-auto mb-6 text-sm md:text-md flex-col items-center text-gray-600 dark:text-gray-100"
      >
        <li class="flex-grow headline big text-violet mb-3">Get paid in tokens with StreamPay:</li>
        <li class="mb-3">
        ...
        <li class="mb-3">
          <i class="fad fa-check text-violet mr-2" />
          <span
            ><a href="https://streampayments.co/api/sdk/checkout/" CLASS="lightLink" target="_blank">StreamPay Checkout SDK</a
    ...
    <div ref="paymentsContainer" class="linkBody py-4 md:py-10">
      ...
      <h2 class="mx-auto text-center container headline big text-violet mb-3" v-html="createLinkBlockTitle" />
    ...
    <div class="linkFooter filter rounded-b px-5">
      <zk-max-height
        ...
        class="mt-0 md:mt-5 md:mt-7 container mx-auto"
      >
        <div>
...
<script lang="ts">
import Vue from "vue";
import { Network } from "streampay/build/types";
