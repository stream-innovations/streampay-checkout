...
const pageTitle = `${CURRENT_APP_NAME}`.toString() ?? "StreamPay Checkout";
...
const config: NuxtConfig = {
  ...
  head: {
    ...
    meta: [
      ...
      },
      {
        hid: "author",
        name: "author",
        content: "https://streampayments.co",
      },
      {
        hid: "twitter:title",
        name: "twitter:title",
      ...
      { hid: "theme-color", name: "theme-color", content: "#000417" },
      {
  ...
  buildModules: [
    ...
    [
      ...
      <ModuleOptions>{
        network: process.env.STREAM_NETWORK,
        apiKeys: {
  ...
  modules: [
    ...
    [
      "nuxt-social-meta",
      {
        url: "https://checkout.streampayments.co",
        title: pageTitle,
        site_name: pageTitle,
        ...
        locale: "en_US",
        twitter: "@@stream_protocol",
        twitter_card: "https://checkout.streampayments.co/social.png",
        themeColor: "#000417",
      },
    ],
    "@nuxtjs/google-gtag",
  ...
  "google-gtag": {
    ...
    config: {
      ...
      linker: {
        domains: ["checkout.streampayments.co", "checkout-goerli.streampayments.co", "web.app"],
      },
    },
